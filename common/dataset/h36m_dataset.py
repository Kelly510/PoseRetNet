...
from common.pose_utils.camera import normalize_screen_coordinates
...
class Human36mDataset(MocapDataset):
    def __init__(self, path, remove_nose=False, remove_static_joints=True):
        ...
        if remove_static_joints:
            if remove_nose:
                self.remove_joints([4, 5, 9, 10, 11, 15, 16, 20, 21, 22, 23, 24, 28, 29, 30, 31])
